...
1. Load dataset
 2. Quick EDA (head)
 3. Select 2 features for plotting decision boundary (optional)and keep full feature set for training3. 
4. Scaling
5. Train SGDClassifier as logistic regression
- loss='log' or 'log_loss' depending on sklearn version- alpha -> L2 regularization strength
6.Evaluation on test set
7.Confusion matrix
8.ROC curve
9.Decision boundary plot (2 features) for visual learners
...
<img width="842" height="448" alt="7 5" src="https://github.com/user-attachments/assets/ddb8b92d-ebd1-427d-b12a-f61a68ee46ac" />
<img width="616" height="545" alt="7 4" src="https://github.com/user-attachments/assets/37127c32-1935-4d74-9157-f6b8329f6936" />
<img width="536" height="468" alt="7 3" src="https://github.com/user-attachments/assets/8e8928f0-1c07-4bea-96ec-bb207542e596" />
<img width="489" height="391" alt="7 2" src="https://github.com/user-attachments/assets/c63ed374-68ba-45e8-9b38-4cb10e981852" />
<img width="501" height="391" alt="7 1" src="https://github.com/user-attachments/assets/f5b4496c-05cc-4718-a21c-e2e1d7ab8948" />
